...
<body>
	...
	<!-- start: Header -->
			...
			<div class="row-fluid">	
				...
				<p>Selamat Datang <?php echo $namax; ?>...!!!</p>
	...
	<footer>
		...
		<p>
			<span style="text-align:center;float:center">&copy; 2015 <a href="#" alt="Bootstrap_Metro_Dashboard">SMA Negeri 19 Makassar</a></span>
